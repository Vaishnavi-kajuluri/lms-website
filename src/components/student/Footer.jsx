     ...
     <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10
       md:gap-32 py-10 border-b border-white/30'>
         ...
         <img src={assets.logo_dark} alt="dark_logo"/>
         <p className='mt-6 text-center md:text-left text-sm text-white/80'>
           With expert instructors and real-world projects, we help bridge the gap
            between knowledge and application.</p>
         </div>
         <div className='flex flex-col md:items-start items-center w-full'>
          <h2 className='font-semibold text-white mb-5'>Company</h2>
          <ul className='flex md:flex-col w-full text-white '>
            <li><a href='#'>Home </a></li>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © Vaishnavi All Rights Reserved</p>
     </footer>
  )
}
