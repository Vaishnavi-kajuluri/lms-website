...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        <h1 className='text-[28px] leading-[34px] md:text-[48px] md:leading-[56px] relative
         font-bold text-gray-800 max-w-3xl mx-auto'>Empower your future with the courses designed to 
          <span className='text-blue-600'> fit your choice.</span><img className='md:block hidden absolute bottom--2 right-0'src={assets.sketch} alt ="sketch"/>
          </h1>
