  ...
  return (
    ...
    <form>
      <div className='flex flex-col gap-1'>
       <p>Course Title</p>
       <input onChange={e=>setCourseTitle(e.target.value)} value={courseTitle} type="text" placeholder='Type here' className='outline-none md:py-2.5
   ...
   <div>
      ...
      type="number" placeholder='0' min={0} max={0} className='outline-none
      md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500 required'/>
   </div>
   <div>
      ...
      <div key={chapterIndex} className='bg-white border rounded-lg mb-4'> 
         <div className='flex justify-between items-center p-4 border-b'> 
            <div className='flex items-center'>
               <img src={assets.dropdown_icon} width={14}
         ...
         {!chapter.collapsed && (
             <div className='p-4'> 
                {chapter.chapterContent.map((lecture,lectureIndex) =>(
                  ...
                  items-center mb-2'>
                     <span>{lectureIndex +1} {lecture.lectureTitle}=
                      {lecture.lectureDuration} mins - <a href={lecture.lectureUrl}
                ...
                cursor-pointer mt-2'>+ Add Lecture </div>   
             </div>
         )}
      </div>
    ))}
    <div className='flex justify-center items-center bg-blue-100 p-2
    rounded-lg cursor-pointer'>+ Add Chapter</div>
    ...
    {showPopup && (
      ...
      bg-gray-800 bg-opacity-50'> 
       ...
       <div className='mb-2'> 
          ...
          <input
             type="text"
             className='mt-1 block 2-full border rounded py-1 px-2'
